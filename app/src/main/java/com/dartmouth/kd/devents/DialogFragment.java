    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        switch (dialog_id) {
            ...
            case DIALOG_ID_MANUAL_INPUT_DATE:
                ...
                textEntryView = new EditText(parent);
                textEntryView.setInputType(InputType.TYPE_CLASS_TEXT);
                textEntryView.setHint(R.string.ui_manual_input_date_hint);
                textEntryView.setLines(4);
                return new AlertDialog.Builder(parent)
                        .setTitle(R.string.ui_manual_input_date)
                        .setView(textEntryView)
                        .setPositiveButton(R.string.ui_button_ok,
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                                        int whichButton) {
                                        ((CreateCampusEvent) parent).onDateSet(textEntryView.getText()
                                                .toString());
            ...
            case DIALOG_ID_MANUAL_INPUT_START:
                ...
                textEntryView = new EditText(parent);
                textEntryView.setInputType(InputType.TYPE_CLASS_TEXT);
                textEntryView.setHint(R.string.ui_manual_input_start_hint);
                textEntryView.setLines(4);
                return new AlertDialog.Builder(parent)
                        .setTitle(R.string.ui_manual_input_start)
                        .setView(textEntryView)
                        .setPositiveButton(R.string.ui_button_ok,
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                                        int whichButton) {
                                        ((CreateCampusEvent) parent).onStartSet(textEntryView.getText()
                                                .toString());
            ...
            case DIALOG_ID_MANUAL_INPUT_END:
                ...
                textEntryView = new EditText(parent);
                textEntryView.setInputType(InputType.TYPE_CLASS_TEXT);
                textEntryView.setHint(R.string.ui_manual_input_end_hint);
                textEntryView.setLines(4);
                return new AlertDialog.Builder(parent)
                        .setTitle(R.string.ui_manual_input_end)
                        .setView(textEntryView)
                        .setPositiveButton(R.string.ui_button_ok,
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                                        int whichButton) {
                                        ((CreateCampusEvent) parent).onEndSet(textEntryView.getText()
                                                .toString());
