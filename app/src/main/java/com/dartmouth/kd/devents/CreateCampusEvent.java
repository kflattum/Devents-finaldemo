...
public class CreateCampusEvent extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                double lat = (double) latlng1.latitude;
                double longi = (double) latlng1.longitude;
                newEvent.setLatitude(lat);
                newEvent.setLongitude(longi);
    ...
    public void onDateSet(String date){
        newEvent.setstrDate(date);
    }

    public void onStartSet(String start) {
        newEvent.setstrStart(start);
    }

    public void onEndSet(String end) {
        newEvent.setstrEnd(end);
    }
